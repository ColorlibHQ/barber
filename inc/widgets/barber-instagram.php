...
----------------------------------------*/
class barber_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('barber_instagram_photo',esc_html__('[ Barber ] Intagram Photo','barber'),array(
			'description' => esc_html__('Barber Instagram Photo Widget','barber'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'barber');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'barber'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'barber'); ?></label>
...
if(!function_exists('barber_instagram_widgets')):
	function barber_instagram_widgets(){
		register_widget('barber_instagram_photo');
	}
	add_action('widgets_init','barber_instagram_widgets');
endif;
