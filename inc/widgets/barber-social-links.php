...
class Barber_social_links extends WP_Widget {
    ...
    function __construct() {
        ...
        esc_html__( '[ Barber ] Social Links', 'barber' ),

        // Widget description
        array( 'description' => esc_html__( 'Add footer social links.', 'barber' ), )
        );
    ...
    public function form( $instance ) {
        ...
        $title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : esc_html__( 'Follow Us', 'barber' );
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'facebook' ) ); ?>"><?php esc_html_e( 'Facebook URL:' ,'barber'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'twitter' ) ); ?>"><?php esc_html_e( 'Twitter URL:' ,'barber'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'linkedin' ) ); ?>"><?php esc_html_e( 'Linkedin URL:' ,'barber'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'behance' ) ); ?>"><?php esc_html_e( 'Behance URL:' ,'barber'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'dribbble' ) ); ?>"><?php esc_html_e( 'Dribbble URL:' ,'barber'); ?></label>
...
} // Class barber_social_links ends here


// Register and load the widget
function barber_social_links_widget_load() {
	register_widget( 'Barber_social_links' );
}
add_action( 'widgets_init', 'barber_social_links_widget_load' );