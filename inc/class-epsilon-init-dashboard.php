...
class Epsilon_init_Dashboard {
	...
	private function _notify_feedback() {
		...
		$html .=
			...
			// Translators: 1 is Theme Name, 2 is opening Anchor, 3 is closing.
				__( 'We\'ve been working hard on making %1$s the best one out there. We\'re interested in hearing your thoughts about %1$s and what we could do to make it even better. %2$sSend your feedback our way%3$s.', 'barber' ),
				array(
					'Barber',
					'<a target="_blank" href="https://bit.ly/feedback-barber">',
					'</a>',
				)
			);
		...
		$notifications->add_notice(
			array(
				'id'      => 'barber_notification_feedback',
	...
	public function init_nav_menus() {
		 new Epsilon_Section_Navigation_Menu( 'barber_frontpage_sections_' );
	}
