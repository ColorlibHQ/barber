(function( $ , api){
    ...
    api.section( 'barber_fof_section' , function( section ){
    ...
    // Customizer about page redirect
    api.section( 'barber_about_section' , function( section ){
    ...
    api.section( 'barber_blog_section' , function( section ){
    ...
    api.section( 'barber_contact_section' , function( section ){

        section.expanded.bind( function( isExpanded ){

            // Customizer contact form seclector 
            var customshortcodefield = $('#customize-control-barber_contact_custom_formshortcode'),
                selector = $('#_customize-input-barber_contact_formshortcode');
    ...
    // General section
    api.section( 'barber_general_section' , function( section ){
        ...
        section.expanded.bind( function( isExpanded ){
            ...
            var $preloader      = $('#barber_preloader_toggle'),
                $preloaderbg    = $( '#customize-control-barber_preloader_bg_color' ),
                $preloadercolor = $( '#customize-control-barber_preloader_color' );
            ...
            var $backtotop          = $( '#barber_backtotop_btn' ),
                $backtotopbg        = $( '#customize-control-barber_backtotop_btn_bg_color' ),
                $backtotophoverbg   = $( '#customize-control-barber_backtotop_btn_hover_bg_color' );
    ...
    // Footer section
    api.section( 'barber_footer_section' , function( section ){
        ...
        section.expanded.bind( function( isExpanded ){
            ...
            var $widget_toggle      = $('#barber_footer_widget_toggle');
