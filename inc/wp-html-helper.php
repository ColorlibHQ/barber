...
// image default alt
if( !function_exists( 'barber_img_default_alt' ) ){
	function barber_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'barber_img_tag' ) ){
	function barber_img_tag( array $args ){
		...
		if( !empty( $args['alt'] ) ){
			...
			$alt = barber_img_default_alt( $url );
		}
...
// Anchor Tag
if( !function_exists( 'barber_anchor_tag' ) ){
	function barber_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'barber_heading_tag' ) ){
	function barber_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'barber_paragraph_tag' ) ){
	function barber_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'barber_other_tag' ) ){
	function barber_other_tag( array $args ){
...
// Button Element 
if( !function_exists( 'barber_button_element ' ) ){
	function barber_button_element( array $args ){
