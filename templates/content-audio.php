...
?>
	...
	<article id="post_<?php the_ID(); ?>" <?php post_class('masonry__brick entry format-audio'); ?> data-aos="fade-up">
		...
		/**
		 * Blog Post Meta
		 * @Hook  barber_blog_posts_meta
		 *
		 * @Hooked barber_blog_posts_meta_cb
		 * 
		 *
		 */
		do_action( 'barber_blog_posts_meta' );
		 ...
		 * @Hook  barber_blog_posts_excerpt
		 *
		 * @Hooked barber_blog_posts_excerpt_cb
		 * 
		 *
		 */
		do_action( 'barber_blog_posts_excerpt' );
